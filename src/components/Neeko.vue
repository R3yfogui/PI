...
<template>
    <div class="wallpaper">
        <video autoplay loop muted plays-inline class="hero">
            <source src="../assets/videos/walphome.mp4" type="video/mp4" />
        </video>
    </div>
    ...
    <body class="is-boxed has-animations">
        <div class="body-wrap boxed-container box-shadow">
            ...
            <main style="background-color: #182538;">
                <section class="hero">
                    <img class=" teste-dos-cria" src="../../images/header-illustration-light.svg"
                    ...
                    <div class="container">
                        ...
                        <div class="teste">
                            <div class="hero-copy">
                                ...
                                <p class="hero-paragraph reveal">Our landing page template works on all devices, so you
                                    only have to set it up once, and get beautiful results forever.</p>
                            ...
                            <div class="header-illustration">
                                ...
                                <div class="hero-media-container">
                                    <img class="hero-media-image asset-dark" src="../../images/hero-media-dark.svg"
                                        alt="Hero media">
                        ...
                        <div class="features-inner section-inner has-bottom-divider">
                            <div class="features-header text-center">
                                <div class="container-sm">
                                    ...
                                    <p class="section-paragraph reveal">Lorem ipsum is common placeholder text used to
                                        demonstrate the graphic elements of a document or visual presentation.</p>
                                    <div class="features-image">
                                        <img class="features-illustration asset-dark reveal"
                                            src="../../images/features-illustration-dark.svg"
                                            alt="Feature illustration">
                                        <img class="features-box asset-dark reveal"
                                            src="../../images/features-box-dark.svg" alt="Feature box">
                                        <img class="features-illustration asset-dark reveal"
                                            src="../../images/features-illustration-top-dark.svg"
                                            alt="Feature illustration top">
                                        <img class="features-illustration asset-light reveal"
                                            src="../../images/features-illustration-dark.svg"
                                            alt="Feature illustration">
                                        <img class="features-box asset-light reveal"
                                            src="../../images/features-box-dark.svg" alt="Feature box">
                                        <img class="features-illustration asset-light reveal"
                                            src="../../images/features-illustration-dark.svg"
                                            alt="Feature illustration top">
                            ...
                            <div class="features-wrap">
                                <div class="feature is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img class="asset-light" src="../../images/feature-01-dark.svg"
                                                alt="Feature 01">
                                            <img class="asset-dark" src="../../images/feature-01-dark.svg"
                                                alt="Feature 01">
                                        </div>
                                        <div class="feature-content">
                                            <h3 class="feature-title mt-0">Discover</h3>
                                            <p class="text-sm mb-0 reveal">Lorem ipsum dolor sit amet, consecte
                                ...
                                <div class="feature is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img class="asset-light" src="../../images/feature-02-dark.svg"
                                                alt="Feature 02">
                                            <img class="asset-dark" src="../../images/feature-02-dark.svg"
                                                alt="Feature 02">
                                        </div>
                                        <div class="feature-content">
                                            <h3 class="feature-title mt-0">Discover</h3>
                                ...
                                <div class="feature is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img class="asset-light" src="../../images/feature-03-dark.svg"
                                                alt="Feature 03">
                                            <img class="asset-dark" src="../../images/feature-03-dark.svg"
                                                alt="Feature 03">
                                        </div>
                                        <div class="feature-content">
                                            <h3 class="feature-title mt-0">Discover</h3>
                                            <p class="text-sm mb-0">Lorem ipsum dolor sit amet, consecte adipiscing
